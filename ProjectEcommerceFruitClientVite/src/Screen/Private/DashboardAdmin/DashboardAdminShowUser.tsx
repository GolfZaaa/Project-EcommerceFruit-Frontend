...
export default observer(function DashboardAdminShowUser() {
  ...
  const fileName = `users_${day}-${month}-${year}`;
          ...
          <div className="min-w-full inline-block align-middle">
            <div className="relative text-gray-500 focus-within:text-gray-900 mb-4">
              ...
              <input
                type="text"
                id="default-search"
                className="block w-80 h-11 pr-16 pl-12 py-2.5 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none bg-white"
                      ...
                      <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
                        ...
                        <td className=" p-5 ">
                          <div className="flex items-center gap-1">
                            ...
                            <button onClick={() =>handleDeleteUser(userItem.id)} className="p-2 rounded-full  group transition-all duration-500  flex item-center">
                              <svg
                                className=""
                                width="20"
                                height="20"
