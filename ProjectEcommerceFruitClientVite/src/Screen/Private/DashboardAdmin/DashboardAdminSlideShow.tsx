...
import CreateSlideShow from "../../slideShow/CreateSlideShow";
import { pathImages } from "../../../constants/RoutePath";
import Swal from "sweetalert2";
import MyContent from "../../../component/MyContent";

const DashboardAdminSlideShow = () => {
  const { slideShow, getSlideShowAdmin, isUsedSlideShow, removeSlideShow } =
    useStore().systemSettingStore;

  const [editMode, setEditMode] = useState(false);
  const [dataEdit, setDataEdit] = useState<SlideShow | null>();
  ...
  return (
    <>
      {editMode ? (
        <CreateSlideShow onChangeCU={onChangeCU} dataEdit={dataEdit} />
      ) : (
        <div className="p-4">
          <Grid
            container
                ...
                <div className="overflow-hidden ">
                  <table className="min-w-full border border-gray-300 rounded-tl-lg rounded-tr-lg overflow-hidden">
                    ...
                    <tbody className="divide-y divide-gray-300">
                      {slideShow.map((userItem: any, index: any) => {
                        return (
                          <tr
                            key={index}
                          ...
                          >
                            ...
                            <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                              {" "}
                              <img
                                src={pathImages.slideShow + userItem.imageName}
...
export default observer(DashboardAdminSlideShow);
