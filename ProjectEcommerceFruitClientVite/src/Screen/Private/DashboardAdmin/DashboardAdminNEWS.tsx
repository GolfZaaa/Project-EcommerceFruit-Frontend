...
const DashboardAdminNEWS = () => {
  ...
  const [dataEdit, setDataEdit] = useState<NEWS | null>();
  ...
  return (
    <>
      {editMode ? (
        <CreateUpdateNEWS onChangeCU={onChangeCU} dataEdit={dataEdit} />
      ) : (
        <div className="p-4">
          <Grid
            container
                ...
                <div className="overflow-hidden ">
                  <table className="min-w-full border border-gray-300 rounded-tl-lg rounded-tr-lg overflow-hidden">
                    ...
                    <tbody className="divide-y divide-gray-300">
                      {news.map((userItem: any, index: any) => {
                        return (
                          <tr
                            key={index}
...
export default observer(DashboardAdminNEWS);
