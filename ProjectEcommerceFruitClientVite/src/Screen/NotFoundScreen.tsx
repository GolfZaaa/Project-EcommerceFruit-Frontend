        ...
        >
          ...
          >
            ...
            <p style={{ marginTop: "1rem", color: "#6b7280" }}>
              โปรดลองค้นหาอีกครั้ง หรือ
              {name ? name : "กลับไปยังหน้าหลักเพื่อเริ่มต้นใหม่"}
            </p>
            <NavLink to={name ? RoutePath.loginScreen : RoutePath.firstscreen}>
              <Button variant="contained">
                {name ? "เข้าสู่ระบบ" : "กลับสู่หน้าหลัก"}
              </Button>
            </NavLink>
          </div>
        </div>
